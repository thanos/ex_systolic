defmodule ExSystolic.TraceTest do
  ...
  describe "new/1" do
    ...
    test "creates trace with initial events" do
      event = %Event{tick: 0, coord: {0, 0}, inputs: %{}, outputs: %{}, state_before: 0, state_after: 0}
  ...
  describe "record/2" do
    ...
    test "events are ordered by recording order" do
      trace = Trace.new()
      e0 = %Event{tick: 0, coord: {0, 0}, inputs: %{}, outputs: %{}, state_before: 0, state_after: 0}
  ...
  describe "for_coord/2" do
    test "filters by coordinate" do
      e0 = %Event{tick: 0, coord: {0, 0}, inputs: %{}, outputs: %{}, state_before: 0, state_after: 0}
      e1 = %Event{tick: 1, coord: {0, 0}, inputs: %{}, outputs: %{}, state_before: 0, state_after: 0}
      e2 = %Event{tick: 0, coord: {1, 1}, inputs: %{}, outputs: %{}, state_before: 0, state_after: 0}
      trace = Trace.new([e0, e1, e2])
